...
def create_usable_dataset(
    root_dir, 
    output_dir='AI-Lab_project/Archive/all_leaf_train',
    csv_filename='AI-Lab_project/Dataset/dataset_leaf_labeled_train.csv'
):
    """

    Given a directory containing subfolders (one per class), this function:
    1. Copies all images into a single directory (all_leaf_train).
...
# # # # #
create_usable_dataset('AI-Lab_project/Archive/trainTest/leaf/train')
